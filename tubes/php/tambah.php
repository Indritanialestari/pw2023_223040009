...
<head>
  ...
  <link rel="shortcut icon" href="../img/tambah.png">
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="ml-5 mt-3">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-4">
            <input type="text" name="alat_bahan" class="form-control" required>
          </div>
        </div>
      </div>
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-4">
            <input type="text" name="cara_membuat" class="form-control" required>
          </div>
        </div>
      </div>
      <div class="form-group">
