...
<body>
  <div class="login-clean" style="height: 800;">
    <h2 class="text-center" style="height: 70px;margin-top: 20px; margin-bottom:20px;color:black;font-family: Allerta, sans-serif;">
    ...
    <form class="mb-5" method="post">
      ...
      <div class="form-group">
        <label for="username" class="text" style="color:grey;">Username :</label><br>
        <input type="text" name="username" id="username" class="form-control" autocomplete="off" style="background-color: rgb(255,255,255);">
      </div>
      <div class="form-group">
        <label for="username" class="text" style="color:grey;">Password :</label><br>
      ...
      <div class="form-group">
        ...
        <input type="submit" name="submit" class="btn btn-block btn-dark btn-md" data-bs-hover-animate="pulse" value="Login" style="background-color: black;">
      </div>
      ...
      <div id="register-link" class="text-right">
        <p class="mb-1">Back to home?</p>
        <a href="../index.php">Here</a>
      </div>
    </form>
    <footer style="margin-top:85px;">
      <p class="copyright text-center" style="opacity: 0.7;filter: brightness(150%) contrast(38%);">Indri Tania Lestari © 2023</p>
    </footer>
  </div>
