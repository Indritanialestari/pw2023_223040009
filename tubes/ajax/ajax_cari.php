    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="nav navbar-nav">
          <li class="nav-item" role="presentation"><a class="nav-link" href=" #Produk">Home</a></li>
  ...
  <div class="photo-gallery">
    <div class="container">
      <div class="intro">
        ...
        <img src="img/croods.png" class="img-fluid mt-5 mb-5" alt="">
      </div>
      <div class="intro">
